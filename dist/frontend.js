...
const SAVE_ICON = `<svg viewBox="0 0 24 24" aria-hidden="true" fill="none"><path d="M5 4.5h11.8L19.5 7v12.5h-15v-15Z" stroke="currentColor" stroke-width="1.55" stroke-linejoin="round"/><path d="M8 4.5v5h8v-5M8 19.5v-6h8v6" stroke="currentColor" stroke-width="1.55" stroke-linejoin="round"/></svg>`;
...
body .ldc-toolbar-save-state[data-prism-save-status=off] i,body .ldc-savebar [data-save-status][data-prism-save-status=off]::before{background:var(--lumiverse-text-dim);box-shadow:none}.ldc-toolbar-save-state[data-prism-save-status=off]{color:var(--lumiverse-text-dim);opacity:.72}
...
.ldc-persona-master{display:flex;align-items:center;justify-content:space-between;gap:14px;margin:14px 18px 0;padding:10px 12px;border:1px solid var(--lumiverse-border);border-radius:11px;background:var(--lumiverse-fill-subtle);cursor:pointer}.ldc-persona-options{display:grid;gap:8px;margin:14px 18px 0}.ldc-persona-master{margin:0}.ldc-persona-master span{display:grid;gap:2px}.ldc-persona-master strong{font-size:10px}.ldc-persona-master small{color:var(--lumiverse-text-dim);font-size:8.5px}.ldc-persona-note{padding:9px 11px;border:1px solid color-mix(in srgb,var(--lumiverse-primary) 28%,var(--lumiverse-border));border-radius:10px;background:color-mix(in srgb,var(--lumiverse-primary) 6%,transparent);color:var(--lumiverse-text-dim);font-size:8.8px;line-height:1.45}.ldc-persona-note strong{color:var(--lumiverse-text)}
...
.ldc-master-row{display:flex;align-items:center;justify-content:space-between;gap:14px;margin:10px 10px 0;padding:10px 11px;border:1px solid color-mix(in srgb,var(--lumiverse-primary) 32%,var(--lumiverse-border));border-radius:13px;background:linear-gradient(90deg,color-mix(in srgb,var(--lumiverse-primary) 11%,transparent),color-mix(in srgb,#5db9ff 5%,transparent));cursor:pointer}.ldc-master-row[data-enabled=false]{border-color:color-mix(in srgb,var(--lumiverse-text-dim) 30%,var(--lumiverse-border));background:color-mix(in srgb,var(--lumiverse-fill-subtle) 78%,transparent)}.ldc-master-copy{display:flex;align-items:center;gap:9px;min-width:0}.ldc-master-icon{display:grid;place-items:center;width:29px;height:29px;flex:0 0 auto;border-radius:10px;background:var(--psoft);color:var(--lumiverse-primary);transition:opacity .16s ease,filter .16s ease}.ldc-master-row[data-enabled=false] .ldc-master-icon{opacity:.5;filter:saturate(.35)}.ldc-master-icon svg{width:15px}.ldc-master-text{display:grid;gap:3px;min-width:0}.ldc-master-title{display:block;font-size:11px;font-weight:850}.ldc-master-desc{display:block;color:var(--lumiverse-text-dim);font-size:9.5px;line-height:1.35}.ldc-master-switch{display:inline-flex;align-items:center;gap:7px;flex:0 0 auto;color:var(--lumiverse-text-muted);font-size:9px;font-weight:800}.ldc-master-switch input{position:absolute;width:1px;height:1px;opacity:0;pointer-events:none}.ldc-master-track{position:relative;display:block;width:38px;height:21px;border:1px solid var(--lumiverse-border);border-radius:999px;background:var(--lumiverse-fill-subtle);box-shadow:inset 0 1px 4px rgba(0,0,0,.28);transition:background .16s ease,border-color .16s ease,box-shadow .16s ease}.ldc-master-track::after{content:"";position:absolute;top:3px;left:3px;width:13px;height:13px;border-radius:50%;background:var(--lumiverse-text-dim);box-shadow:0 2px 5px rgba(0,0,0,.32);transition:transform .16s ease,background .16s ease}.ldc-master-switch input:checked+.ldc-master-track{border-color:color-mix(in srgb,var(--lumiverse-primary) 65%,var(--lumiverse-border));background:color-mix(in srgb,var(--lumiverse-primary) 28%,var(--lumiverse-fill-subtle));box-shadow:0 0 12px color-mix(in srgb,var(--lumiverse-primary) 16%,transparent),inset 0 1px 4px rgba(0,0,0,.2)}.ldc-master-switch input:checked+.ldc-master-track::after{transform:translateX(17px);background:var(--lumiverse-primary)}.ldc-master-switch input:focus-visible+.ldc-master-track{outline:2px solid color-mix(in srgb,var(--lumiverse-primary) 70%,transparent);outline-offset:2px}.ldc-shell[data-prism-enabled=false] .ldc-master-gated{opacity:.38;filter:saturate(.52);pointer-events:none;user-select:none}.ldc-shell[data-prism-enabled=false] .ldc-master-gated *{cursor:default!important}@media(max-width:620px){.ldc-master-row{gap:10px;padding:9px 10px}.ldc-master-desc{font-size:8.8px}.ldc-master-switch>span:last-child{display:none}}
...
.ldc-review-strip{display:flex;align-items:center;justify-content:flex-end;gap:5px;min-width:0}.ldc-review-strip:empty{display:none}.ldc-top-tools{display:flex;align-items:center;justify-content:flex-end;gap:4px;min-width:0}.ldc-top>.ldc-engine{justify-self:end}.ldc-shell[data-prism-layout=tabs] .ldc-top>.ldc-engine,.ldc-shell[data-prism-layout=tabs] .ldc-top>.ldc-top-tools{display:none}.ldc-shell[data-prism-layout=tabs] .ldc-review-strip{margin-left:auto}.ldc-remove-character,.ldc-save-now{width:34px!important;height:34px!important;min-width:34px!important;min-height:34px!important;padding:0!important;border-radius:10px!important}.ldc-remove-character{border-color:color-mix(in srgb,var(--lumiverse-danger,#ef5f66) 42%,var(--lumiverse-border))!important;color:var(--lumiverse-danger,#ef5f66)!important;background:color-mix(in srgb,var(--lumiverse-danger,#ef5f66) 7%,transparent)!important}.ldc-remove-character:hover{background:color-mix(in srgb,var(--lumiverse-danger,#ef5f66) 15%,transparent)!important}.ldc-save-now{display:grid!important;place-items:center;border-color:color-mix(in srgb,var(--lumiverse-primary) 45%,var(--lumiverse-border))!important;color:var(--lumiverse-primary)!important;background:color-mix(in srgb,var(--lumiverse-primary) 8%,transparent)!important}.ldc-save-now:hover{background:color-mix(in srgb,var(--lumiverse-primary) 16%,transparent)!important}.ldc-remove-character span{display:none!important}.ldc-remove-character svg,.ldc-save-now svg{width:16px;height:16px}.ldc-identity-danger{display:flex;justify-content:flex-end;gap:7px}.ldc-reverse-button{display:grid!important;place-items:center;width:34px!important;height:34px!important;min-width:34px!important;min-height:34px!important;padding:0!important;border-radius:10px!important}.ldc-reverse-button svg{width:17px;height:17px}.ldc-scene-menu-trigger{width:38px;min-width:38px;min-height:34px;padding:0;font-size:0}.ldc-scene-menu-trigger b{font-size:18px;letter-spacing:.08em}
...
export function setup(ctx) {
    ...
    function prismEnabled() { const preferences = state?.preferences || uiPreferenceCache || {}; return preferences.prismEnabled !== false; }
    ...
    function mountManualSaveActions(root) { root?.querySelectorAll('.ldc-remove-character').forEach(remove => { if (remove.parentElement?.querySelector('[data-action=save-now]'))
        return; const button = document.createElement('button'); button.type = 'button'; button.className = 'ldc-btn ldc-save-now'; button.dataset.action = 'save-now'; button.title = 'Save color changes now'; button.setAttribute('aria-label', 'Save color changes now'); button.innerHTML = SAVE_ICON; remove.parentElement?.insertBefore(button, remove); }); }
    ...
    function missingCount() { return (state?.characters || []).filter(c => !bindingRegistryColor(c.binding)).length + ((state?.config?.personaEnabled !== false || state?.config?.personaInCast === true) && state?.persona && !bindingRegistryColor(state.persona.binding) ? 1 : 0); }
    ...
    function visiblePrismStatus() { if (saveStatus === 'error' || hydrationStatus === 'error')
        ...
        return { state: 'syncing', label: 'Syncing…' }; if (!prismEnabled())
        return { state: 'off', label: 'Prism off' }; if (pendingReviewCount > 0)
    ...
    function editorPanel(target, isPersona) {
        ...
        const personaMaster = isPersona ? `<div class="ldc-persona-options"><label class="ldc-persona-master"><span><strong>Color persona messages</strong><small>Automatically paints your user-role persona dialogue. This choice becomes the default for new chats.</small></span><input type="checkbox" data-role="persona-enabled" ${state.config.personaEnabled !== false ? 'checked' : ''}></label><label class="ldc-persona-master"><span><strong>Persona is part of the cast</strong><small>For impersonation / Speak for User. Lets assistant-side dialogue resolve to ${esc(target.name)} and exposes the persona in manual recoloring.</small></span><input type="checkbox" data-role="persona-in-cast" ${state.config.personaInCast === true ? 'checked' : ''}></label><div class="ldc-persona-note"><strong>Two separate jobs:</strong> persona-message coloring only targets your user messages. Cast mode is what makes the active persona a possible speaker inside assistant output.</div></div>` : '';
    ...
    function render() {
        ...
        const engineControls = `<div class="ldc-engine ldc-master-gated"${gatedAttr}><button data-engine="dom" data-active="${engine === 'dom'}" title="Render-only heuristic coloring">Local</button><button data-engine="hybrid" data-active="${engine === 'hybrid'}" title="Persist model font tags, then fill untagged gaps locally">Hybrid</button><button data-engine="llm" data-active="${engine === 'llm'}" title="Use only model-emitted font tags">LLM</button></div>`;
        const topTools = `<div class="ldc-top-tools"><button class="ldc-icon" data-action="toggle-expanded" title="${expanded ? 'Restore Prism size' : 'Expand Prism'}" aria-label="${expanded ? 'Restore Prism size' : 'Expand Prism'}">${expanded ? COLLAPSE_ICON : EXPAND_ICON}</button><button class="ldc-icon" data-action="settings" data-active="${settingsOpen}" title="Prism settings" aria-label="Prism settings">${GEAR_ICON}</button></div>`;
        modal.root.innerHTML = `<div class="ldc-shell" data-prism-size="${esc(ui.modalSize)}" data-prism-expanded="${expanded}" data-prism-ultrawide="${ultrawide}" data-prism-layout="${modalLayout}" data-prism-density="${horizontalLayout ? 'carousel' : 'standard'}" data-prism-show-save="${ui.showSaveIndicator}" data-prism-effective-scale="${effectiveUiScale.toFixed(2)}" data-prism-enabled="${prismOn}"><div class="ldc-top"><div class="ldc-tabs"><button class="ldc-tab" data-tab="character" data-active="${activeTab === 'character' && !settingsOpen && !reviewOpen}">Characters</button><button class="ldc-tab" data-tab="persona" data-active="${activeTab === 'persona' && !settingsOpen && !reviewOpen}">Persona</button><button class="ldc-tab ldc-settings-tab" data-action="settings-tab" data-active="${settingsOpen && !reviewOpen}">Settings</button></div><div class="ldc-review-strip ldc-master-gated"${gatedAttr}><span class="ldc-engine-copy">${esc(engineDescription(engine))}</span>${reviewControls}</div>${engineControls}${topTools}</div>${utilityRail}<label class="ldc-master-row" data-enabled="${prismOn}"><span class="ldc-master-copy"><span class="ldc-master-icon">${PRISM_ICON}</span><span class="ldc-master-text"><span class="ldc-master-title">${prismOn ? 'Prism is on' : 'Prism is off'}</span><span class="ldc-master-desc">${prismOn ? 'Dialogue coloring, attribution, persona handling, and generation hooks are active.' : 'Prompt injection, automatic coloring, attribution, and Hybrid discovery are paused. Your saved colors stay intact.'}</span></span></span><span class="ldc-master-switch"><input type="checkbox" data-role="prism-enabled" aria-label="Enable Prism" ${prismOn ? 'checked' : ''}><span class="ldc-master-track" aria-hidden="true"></span><span>${prismOn ? 'On' : 'Off'}</span></span></label>${needs ? `<div class="ldc-setup ldc-master-gated"${gatedAttr}><div class="ldc-setup-copy"><span class="ldc-setup-icon">${SPARK_ICON}</span><div><div class="ldc-setup-title">${esc(setupTitle)}</div><div class="ldc-setup-desc">Found ${state.characters.length} characters${state.persona ? ' and your active persona' : ''}. Existing imported and manual colors stay untouched.</div></div></div><button class="ldc-mini" data-action="setup">Set up scene</button></div>` : ''}<div class="ldc-main-wrap ldc-master-gated"${gatedAttr}><div class="ldc-main">${activeTab === 'character' ? `<aside class="ldc-side">${sidebar()}</aside><section class="ldc-panel">${charPanel(current())}${horizontalLayout ? `<div class="ldc-horizontal-status"><span>${esc(state.chat.name)}</span><span class="ldc-bridge">${engineLabel(engine)} · ${state.characters.length} characters · ${esc(cortexSummary())}</span></div>` : ''}</section>` : `<aside class="ldc-side"><div class="ldc-side-label">Active persona</div><div class="ldc-person" data-active="true"><span class="ldc-avatar">${esc(initials(state.persona?.name))}</span><span class="ldc-person-copy"><span class="ldc-person-name">${esc(state.persona?.name || 'No persona')}</span><span class="ldc-person-source">${state.config.personaEnabled === false ? 'disabled' : 'currently applied'}</span></span></div></aside><section class="ldc-panel">${personaPanel()}${horizontalLayout ? `<div class="ldc-horizontal-status"><span>${esc(state.chat.name)}</span><span class="ldc-bridge">${engineLabel(engine)} · ${state.characters.length} characters · ${esc(cortexSummary())}</span></div>` : ''}</section>`}</div>${reviewOpen ? reviewPanel() : settingsOpen ? settingsPanel() : ''}</div>${horizontalLayout ? '' : `<div class="ldc-status ldc-master-gated"${gatedAttr}><span>${esc(state.chat.name)}</span><span class="ldc-bridge">${engineLabel(engine)} · ${state.characters.length} characters · Cortex ${state.cortexAvailable ? 'linked' : 'unavailable'}</span></div>`}</div>`;
        hydrateScaleOptions(modal.root, ui.modalScale);
        mountManualSaveActions(modal.root);
    ...
    async function saveEditorNow() { clearTimeout(saveTimer); const generation = ++saveGeneration; setSaveStatus('saving'); await saveQueue.catch(() => { }); await saveEditor(activeTab === 'persona' ? 'persona' : 'character', false); if (generation === saveGeneration)
        setSaveStatus('saved'); }
    ...
    function wire() {
        ...
        modal.root.querySelectorAll('[data-action=save-now]').forEach(button => button.addEventListener('click', () => perform(saveEditorNow)));
        ...
        modal.root.querySelector('[data-role=prism-enabled]')?.addEventListener('change', e => perform(async () => { const next = e.target.checked, prefs = await saveUiPreferences({ prismEnabled: next }); acceptUiPreferences(prefs); if (!next) {
            setHydrationStatus('idle');
            hydratingMessages.clear();
            clearAllStreaming();
        } revision++; signatures.clear(); for (const { messageId } of ctx.dom.listMessageElements())
            dirty.add(messageId); schedule(true); rebuildToolbar(); render(); }));
        ...
        modal.root.querySelector('[data-role=persona-in-cast]')?.addEventListener('change', e => perform(async () => { const r = await request('ldc_update_options', { engine: state.config.engine, personaInCast: e.target.checked }); acceptState(r.state); render(); }));
        ...
        modal.root.querySelector('[data-role=bake-manual]')?.addEventListener('change', e => perform(async () => { const r = await request('ldc_update_options', { engine: state.config.engine, bakeManualCorrections: e.target.checked }); acceptState(r.state); render(); }));
    ...
    function candidates() {
        ...
        const persona = state?.config?.personaInCast === true && state?.persona ? state.persona : null, personaBinding = persona?.binding || null, personaColor = bindingRegistryColor(personaBinding), personaStableId = persona ? String(personaBinding?.speakerUid || personaBinding?.targetId || persona.id || persona.name) : '', personaCandidate = persona ? { key: `persona:${personaStableId}`, id: String(persona.id || ''), characterId: '', name: persona.name, names: [...new Set([persona.name, ...(personaBinding?.aliases || [])].map(x => String(x || '').trim().toLowerCase()).filter(Boolean))], color: personaColor, binding: personaBinding, channels: personaColor ? safeChannels(personaBinding) : null, paintable: Boolean(personaColor), primary: false, tentative: false, persona: true } : null;
        ...
        return [...confirmed, ...(personaCandidate ? [personaCandidate] : []), ...tentative];
    }
    ...
    function normalizedLocator(value) { return String(value || '').replace(/\s+/g, ' ').trim().toLowerCase(); }
    function quoteOccurrenceIndex(text, start, quote) { const needle = normalizedLocator(quote), before = normalizedLocator(String(text || '').slice(0, Math.max(0, start))); if (!needle)
        return 0; let count = 0, offset = 0; while (offset <= before.length - needle.length) {
        const found = before.indexOf(needle, offset);
        if (found < 0)
            break;
        count += 1;
        offset = found + Math.max(1, needle.length);
    } return count; }
    function locatorDetail(text, start, end, quote) { return { occurrenceIndex: quoteOccurrenceIndex(text, start, quote), contextBefore: String(text || '').slice(Math.max(0, start - 80), start), contextAfter: String(text || '').slice(end, end + 80) }; }
    async function teach(event, detail, list) {
        ...
        try {
            const response = await request('ldc_save_override', { chatId: state.chat.id, messageId: detail.messageId, swipeId: detail.swipeId, contentHash: detail.contentHash, segmentKey: detail.segmentKey, quote: detail.quote, speakerKey, kind, existingColor: detail.existingColor || null, occurrenceIndex: detail.occurrenceIndex || 0, contextBefore: detail.contextBefore || '', contextAfter: detail.contextAfter || '' });
            acceptState(response.state);
            setSaveStatus('saved');
            if (response.bake && ['quote-not-found', 'message-not-found', 'swipe-not-found', 'speaker-has-no-color', 'error'].includes(response.bake.status)) {
                perform(async () => ctx.ui.showConfirm({ title: 'Correction saved, bake skipped', message: response.bake.status === 'quote-not-found' ? 'Prism kept the manual correction, but could not safely locate that exact segment in the stored message. Nothing was rewritten.' : `Prism kept the manual correction, but the persistent bake could not be applied (${response.bake.error || response.bake.status}).`, confirmLabel: 'Okay', cancelLabel: 'Close', variant: 'warning' }));
            }
            if (modal)
                render();
        }
    ...
    function colorQuotes(root, mc, list, fixed = null, fillMissing = true) {
        ...
        for (const event of events) {
            ...
            if (event.type === 'existing') {
                ...
                decorate(unit.element, { messageId: mc.messageId, swipeId: mc.swipeId, segmentKey, contentHash, quote: unit.text, attribution, kind, existingColor: segment.color, ...locatorDetail(text, unit.start, unit.end, unit.text) }, list);
            ...
            jobs.push({ parts: event.parts, quote: event.quote, segmentKey, contentHash, attribution, kind, ...locatorDetail(text, event.start, event.end, event.quote) });
        }
        for (let i = jobs.length - 1; i >= 0; i--) {
            ...
            decorate(span, { messageId: mc.messageId, swipeId: mc.swipeId, segmentKey: job.segmentKey, contentHash: job.contentHash, quote: job.quote, attribution: job.attribution, kind: job.kind, hybridDeferred, occurrenceIndex: job.occurrenceIndex, contextBefore: job.contextBefore, contextAfter: job.contextAfter }, list);
        }
    ...
    function processMounted(force = false) {
        ...
        observer.disconnect();
        try {
            const enabled = prismEnabled(), list = enabled ? candidates() : [], personaBinding = enabled && state?.config?.personaEnabled !== false ? state?.persona?.binding : null, personaColor = bindingRegistryColor(personaBinding);
    ...
    function markStreaming(payload = {}) { if (!prismEnabled())
        return; if (payload.chatId && state?.chat?.id && String(payload.chatId) !== String(state.chat.id))
    ...
    async function hydrateMessage(payload = {}, force = false, quiet = false) {
        ...
        markLatest();
        if (!messageId || !state?.ok || !prismEnabled() || normalizeEngine(state.config.engine) !== 'hybrid' || hydratingMessages.has(messageId))
            return;
