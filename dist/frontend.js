...
.ldc-shell[data-prism-layout=tabs] .ldc-settings-tab,.ldc-shell[data-prism-layout=tabs] .ldc-roster-settings{display:block}
.ldc-shell[data-prism-layout=tabs] .ldc-top-actions{flex:1 1 100%;flex-wrap:wrap;justify-content:flex-end;gap:5px}
...
@media(max-width:620px){.ldc-shell[data-prism-layout=tabs] .ldc-top-actions{justify-content:flex-start}.ldc-shell[data-prism-layout=tabs] .ldc-engine{margin-left:0}.ldc-shell[data-prism-layout=tabs] .ldc-side{display:grid;grid-template-columns:minmax(0,1fr);gap:6px}.ldc-shell[data-prism-layout=tabs] .ldc-side-actions{display:grid;grid-template-columns:repeat(2,minmax(0,1fr))}.ldc-shell[data-prism-layout=tabs] .ldc-side-actions .ldc-btn{min-width:0;white-space:normal}.ldc-shell[data-prism-layout=tabs] .ldc-panel{padding:10px}.ldc-shell[data-prism-layout=tabs] .ldc-preview{margin:8px 10px}.ldc-shell[data-prism-layout=tabs] .ldc-editor-controls{padding:0 10px 8px}}
...
export function setup(ctx) {
    ...
    function wire() {
        ...
        modal.root.querySelector('[data-action=toggle-expanded]')?.addEventListener('click', () => perform(async () => { const next = !uiPreferences().modalExpanded; await saveUiPreferences({ modalExpanded: next }); await reopenPalette(); }));
        ...
        modal.root.querySelector('[data-role=save-indicator]')?.addEventListener('change', e => perform(async () => { await saveUiPreferences({ showSaveIndicator: e.target.checked }); rebuildToolbar(); render(); }));
