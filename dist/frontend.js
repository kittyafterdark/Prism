...
.ldc-shell[data-prism-layout=tabs] .ldc-top{align-items:stretch;flex-wrap:wrap;gap:5px 8px}
...
@media(max-width:620px){.ldc-shell[data-prism-layout=tabs] .ldc-top-actions{justify-content:flex-start}.ldc-shell[data-prism-layout=tabs] .ldc-engine{margin-left:0}.ldc-shell[data-prism-layout=tabs] .ldc-side{display:grid;grid-template-columns:minmax(0,1fr);gap:6px}.ldc-shell[data-prism-layout=tabs] .ldc-side-actions{display:grid;grid-template-columns:repeat(3,minmax(0,1fr))}.ldc-shell[data-prism-layout=tabs] .ldc-side-actions .ldc-btn{min-width:0;white-space:normal}.ldc-shell[data-prism-layout=tabs] .ldc-panel{padding:10px}.ldc-shell[data-prism-layout=tabs] .ldc-preview{margin:8px 10px}.ldc-shell[data-prism-layout=tabs] .ldc-editor-controls{padding:0 10px 8px}}
`;
const VERBS = [
