...
.ldc-shell[data-prism-layout=split][data-prism-density=landscape] .ldc-main{grid-template-columns:minmax(165px,205px) minmax(0,1fr)}
.ldc-shell[data-prism-layout=split][data-prism-density=landscape] .ldc-panel,.ldc-shell[data-prism-layout=split][data-prism-density=landscape] .ldc-side{scrollbar-gutter:auto}
...
export function setup(ctx) {
    ...
    function sidebar() {
        ...
        return `<div class="ldc-side-label">Scene roster</div><div class="ldc-roster-scroll">${rows || '<div class="ldc-empty">No characters added yet.</div>'}${tentative ? `<div class="ldc-side-label ldc-tentative-label">New tagged speakers</div>${tentative}` : ''}</div><div class="ldc-side-actions"><button class="ldc-btn" data-action="add-person">+ Add character</button><button class="ldc-btn" data-action="assign">Assign missing</button><button class="ldc-btn" data-action="regenerate">Regenerate</button></div>`;
    }
