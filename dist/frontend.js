...
export function setup(ctx) {
    ...
    function modalContentScale(ui, expanded, ultrawide) { const base = visibleViewportWidth() <= 720 ? 1 : expanded ? 1.12 : ui.modalSize === 'compact' ? 0.92 : ui.modalSize === 'large' || (ultrawide && ui.modalSize === 'auto') ? 1.1 : 1; return Math.max(.82, Math.min(1.4, base * ui.modalScale)); }
