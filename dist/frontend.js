...
.ldc-shell[data-prism-layout=split][data-prism-density=landscape]{width:121.95122%!important;height:121.95122%!important;min-height:0!important;max-width:none!important;max-height:none!important;zoom:.82}
.ldc-shell[data-prism-layout=split][data-prism-density=landscape] .ldc-main{display:flex;flex-direction:column;grid-template-columns:none;min-height:0}
.ldc-shell[data-prism-layout=split][data-prism-density=landscape] .ldc-side{display:grid;grid-template-columns:minmax(0,1fr);flex:0 0 auto;max-height:none;padding:9px 12px 10px;overflow:visible;border-right:0;border-bottom:1px solid var(--lumiverse-border);background:linear-gradient(180deg,color-mix(in srgb,var(--lumiverse-bg-elevated) 96%,transparent),color-mix(in srgb,var(--lumiverse-bg-elevated) 84%,transparent));scrollbar-gutter:auto}
.ldc-shell[data-prism-layout=split][data-prism-density=landscape] .ldc-side>.ldc-side-label{display:none}
.ldc-shell[data-prism-layout=split][data-prism-density=landscape] .ldc-roster-rail{position:relative;display:grid;grid-template-columns:30px minmax(0,1fr) 30px;align-items:center;gap:7px;min-width:0;padding:5px;border:1px solid color-mix(in srgb,var(--lumiverse-primary) 20%,var(--lumiverse-border));border-radius:15px;background:linear-gradient(145deg,color-mix(in srgb,var(--lumiverse-primary) 7%,transparent),var(--lumiverse-fill-subtle));box-shadow:inset 0 1px rgba(255,255,255,.035)}
.ldc-shell[data-prism-layout=split][data-prism-density=landscape] .ldc-roster-nav{display:grid;place-items:center;width:30px;height:30px;padding:0;border:1px solid var(--lumiverse-border);border-radius:10px;background:color-mix(in srgb,var(--lumiverse-bg-elevated) 82%,transparent);color:var(--lumiverse-text-muted);font-size:21px;line-height:1;cursor:pointer}
.ldc-shell[data-prism-layout=split][data-prism-density=landscape] .ldc-roster-nav:hover{border-color:color-mix(in srgb,var(--lumiverse-primary) 58%,var(--lumiverse-border));background:var(--psoft);color:var(--lumiverse-primary)}
.ldc-shell[data-prism-layout=split][data-prism-density=landscape] .ldc-roster-scroll{display:flex;align-items:center;gap:7px;min-width:0;padding:3px 6px 7px;overflow-x:auto;overflow-y:hidden;scroll-snap-type:x proximity;scroll-padding-inline:8px;overscroll-behavior-inline:contain;scrollbar-width:thin;scrollbar-color:color-mix(in srgb,var(--lumiverse-primary) 48%,transparent) transparent;mask-image:linear-gradient(90deg,transparent 0,#000 18px,#000 calc(100% - 18px),transparent 100%)}
.ldc-shell[data-prism-layout=split][data-prism-density=landscape] .ldc-roster-scroll::-webkit-scrollbar{height:5px}.ldc-shell[data-prism-layout=split][data-prism-density=landscape] .ldc-roster-scroll::-webkit-scrollbar-track{background:transparent}.ldc-shell[data-prism-layout=split][data-prism-density=landscape] .ldc-roster-scroll::-webkit-scrollbar-thumb{border-radius:999px;background:linear-gradient(90deg,color-mix(in srgb,var(--lumiverse-primary) 38%,transparent),color-mix(in srgb,#63d9ef 42%,transparent))}
.ldc-shell[data-prism-layout=split][data-prism-density=landscape] .ldc-roster-scroll>.ldc-side-label{display:none}
.ldc-shell[data-prism-layout=split][data-prism-density=landscape] .ldc-person{flex:0 0 auto;width:auto;min-width:max-content;gap:8px;padding:7px 11px;border-color:color-mix(in srgb,var(--lumiverse-border) 75%,transparent);border-radius:999px;background:color-mix(in srgb,var(--lumiverse-bg-elevated) 70%,transparent);scroll-snap-align:center}
.ldc-shell[data-prism-layout=split][data-prism-density=landscape] .ldc-person+.ldc-person{margin-top:0}
.ldc-shell[data-prism-layout=split][data-prism-density=landscape] .ldc-person:hover{border-color:color-mix(in srgb,var(--lumiverse-primary) 34%,var(--lumiverse-border));background:color-mix(in srgb,var(--lumiverse-primary) 8%,var(--lumiverse-fill-subtle))}
.ldc-shell[data-prism-layout=split][data-prism-density=landscape] .ldc-person[data-active=true]{border-color:var(--lumiverse-primary);background:linear-gradient(145deg,color-mix(in srgb,var(--lumiverse-primary) 18%,transparent),color-mix(in srgb,var(--lumiverse-fill-subtle) 92%,transparent));box-shadow:0 0 16px color-mix(in srgb,var(--lumiverse-primary) 13%,transparent),inset 0 1px rgba(255,255,255,.06)}
.ldc-shell[data-prism-layout=split][data-prism-density=landscape] .ldc-avatar{width:18px;height:18px;border-radius:50%;background:transparent;font-size:0}
.ldc-shell[data-prism-layout=split][data-prism-density=landscape] .ldc-inline-swatch{inset:0;width:18px;height:18px;border-width:1px;box-shadow:0 0 10px color-mix(in srgb,var(--swatch,#777) 62%,transparent)}
.ldc-shell[data-prism-layout=split][data-prism-density=landscape] .ldc-inline-picker{inset:-5px;width:28px;height:28px}
.ldc-shell[data-prism-layout=split][data-prism-density=landscape] .ldc-person-copy{flex:0 1 auto}.ldc-shell[data-prism-layout=split][data-prism-density=landscape] .ldc-person-name{max-width:145px;font-size:10.5px}.ldc-shell[data-prism-layout=split][data-prism-density=landscape] .ldc-person-source,.ldc-shell[data-prism-layout=split][data-prism-density=landscape] .ldc-person>span:last-child{display:none}
.ldc-shell[data-prism-layout=split][data-prism-density=landscape] .ldc-side-actions{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:7px;margin:8px 0 0;padding:0;border:0}.ldc-shell[data-prism-layout=split][data-prism-density=landscape] .ldc-side-actions [data-action=add-person]{grid-column:auto}.ldc-shell[data-prism-layout=split][data-prism-density=landscape] .ldc-side-actions .ldc-btn{min-height:32px;padding:7px 9px}
.ldc-shell[data-prism-layout=split][data-prism-density=landscape] .ldc-panel{flex:1 1 0;min-height:0;padding-top:14px;overflow:auto;scrollbar-gutter:auto}.ldc-shell[data-prism-layout=split][data-prism-density=landscape] .ldc-editor-head{display:none}.ldc-shell[data-prism-layout=split][data-prism-density=landscape] .ldc-preview{margin-top:0}
...
export function setup(ctx) {
    ...
    let modal = null, modalHostHandle = null, fullscreenOverlay = null, addModal = null, importModal = null, state = null, activeTab = 'character', activeChannel = 'dialogue', activeEditorPage = 'paint', selectedId = null, sideScroll = 0, sideScrollLeft = 0, panelScroll = 0, settingsOpen = false, reviewOpen = false, busy = false, saveStatus = 'saved', hydrationStatus = 'idle', pendingReviewCount = 0, reviewIndex = 0, toolbarInjection = null, refreshTimer = 0, saveTimer = 0, longTimer = 0, editorPageTimer = 0, applying = false, revision = 0, saveGeneration = 0, saveQueue = Promise.resolve(), stateLoadPromise = null, lastRoundtripMs = 0, lastBackendError = '', themeColorCache = null, themeColorSignature = '';
    ...
    function uiPreferences() { const preferences = state?.preferences || {}; return { modalSize: ['auto', 'compact', 'large'].includes(preferences.modalSize) ? preferences.modalSize : 'auto', modalExpanded: preferences.modalExpanded === true, modalLayout: ['auto', 'split', 'tabs'].includes(preferences.modalLayout) ? preferences.modalLayout : 'auto', showSaveIndicator: preferences.showSaveIndicator !== false }; }
    function acceptUiPreferences(preferences) { if (!state)
    ...
    function syncFullscreenViewport() { const value = `${visibleViewportHeight()}px`; for (const root of [fullscreenOverlay, modal?.root])
        if (root?.classList?.contains('ldc-fullscreen-root'))
            root.style.setProperty('--prism-viewport-height', value); }
    function resolvedModalLayout() { const preference = uiPreferences().modalLayout; if (preference === 'tabs' || preference === 'split')
        return preference; const scale = detectedUiScale(), effectiveWidth = (window.innerWidth || 1280) / scale; return scale > 1.15 || effectiveWidth < 860 || window.innerWidth <= 820 ? 'tabs' : 'split'; }
    function useLandscapeSplitAspect() { const preferences = uiPreferences(), vw = Math.max(320, window.innerWidth || 1280); return resolvedModalLayout() === 'split' && preferences.modalExpanded !== true && vw <= 980; }
    function useLandscapeSplitDensity() { const preferences = uiPreferences(); return useLandscapeSplitAspect() && preferences.modalSize === 'auto'; }
    function isUltrawideViewport() { return window.innerWidth >= 2200 && window.innerHeight >= 850; }
    function modalDimensions() { const { modalSize, modalExpanded } = uiPreferences(), vw = Math.max(320, window.innerWidth || 1280), vh = Math.max(480, visibleViewportHeight()), mobile = vw <= 720, landscapeSplit = useLandscapeSplitAspect(), clampHeight = (target, min, safe) => Math.max(300, Math.min(safe, Math.max(Math.min(min, safe), Math.floor(target)))); let width, contentHeight; if (mobile) {
        ...
        width = Math.min(Math.floor(vw * .96), 1040);
        contentHeight = clampHeight(width * .68, 430, vh - 118);
    } const maxHeight = Math.max(360, Math.min(vh - 24, contentHeight + 96)); return { width: Math.max(360, width), contentHeight, maxHeight, landscapeSplit }; }
    ...
    async function showPrismConfirm(options) {
        if (resolvedModalLayout() !== 'tabs')
            return ctx.ui.showConfirm(options);
    ...
    function render() {
        ...
        const missing = missingCount(), engine = normalizeEngine(state.config.engine), needs = missing > 0, ui = uiPreferences(), expanded = ui.modalExpanded === true, ultrawide = isUltrawideViewport(), modalLayout = resolvedModalLayout(), landscapeDensity = useLandscapeSplitDensity(), effectiveUiScale = detectedUiScale();
        ...
        if (nextRoster && activeTab === 'character') {
            ...
            if (landscapeDensity)
                requestAnimationFrame(() => modal?.root.querySelector('.ldc-person[data-active=true]')?.scrollIntoView({ behavior: 'smooth', block: 'nearest', inline: 'center' }));
        }
        if (nextScroller)
    ...
    function openAddPerson(seedColor = null) {
        ...
        addModal = resolvedModalLayout() === 'tabs' ? createPortalDialog('Add scene character') : ctx.ui.showModal({ title: 'Add scene character', width: 390, maxHeight: 360 });
        ...
        const submit = async () => { const name = String(nameInput?.value || '').trim(), aliases = String(addModal?.root.querySelector('[data-add-role=aliases]')?.value || '').split(',').map(x => x.trim()).filter(Boolean); if (!name)
            ...
            addModal = null;
            render();
            requestAnimationFrame(() => modal?.root.querySelector(`[data-character-id="${CSS.escape(String(added.id))}"]`)?.scrollIntoView({ block: 'nearest' }));
        }
        catch (error) {
    ...
    const onViewportChange = () => { if (modal?.root?.classList.contains('ldc-fullscreen-root'))
        syncFullscreenViewport(); };
